...
class Copyright_Option extends Basic
{
    ...
    public static function init($arg1)
    {
        ...
        //
        $default_notice = file_get_contents( dirname(__FILE__)."/../inc/wp-speak-license-default.html");
        ...
        $mit_notice = file_get_contents( dirname(__FILE__)."/../inc/wp-speak-license-mit.html");
        ...
        $gpl3_notice = file_get_contents( dirname(__FILE__)."/../inc/wp-speak-license-GPL3.html");
