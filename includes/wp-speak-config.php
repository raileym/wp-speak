...
define("WP_SPEAK_INCLUDES_PATH", dirname(__FILE__)."/");
define("WP_SPEAK_CLASSES_PATH",  dirname(__FILE__)."/classes/");
define("WP_SPEAK_INCLUDES_URL",  plugins_url()."/wp-speak/includes/");
define("WP_SPEAK_DIST_URL",      plugins_url()."/wp-speak/js/dist/");
define("WP_SPEAK_JS_URL",        plugins_url()."/wp-speak/js/src/");
//define("WP_SPEAK_SHORTURL", "http://bca.io/");
define("WP_SPEAK_SHORTURL", "https://wp-speak.com/");

define("WP_SPEAK_CSS_PATH",        		  WP_SPEAK_INCLUDES_PATH . "wp-speak.css");
define("WP_SPEAK_CSS_URL",         		  WP_SPEAK_INCLUDES_URL  . "wp-speak.css"); 
define("WP_SPEAK_TITLE_CSS_URL",          WP_SPEAK_INCLUDES_URL  . "wp-speak-title.css"); 
define("WP_SPEAK_ADMIN_CSS_URL",          WP_SPEAK_INCLUDES_URL  . "wp-speak-admin.css"); 
define("WP_SPEAK_PREVIEW_CSS_URL",        WP_SPEAK_INCLUDES_URL  . "wp-speak-preview.css"); 

define("WP_SPEAK_CUSTOM_IFRAME_CSS_URL",  WP_SPEAK_INCLUDES_URL  . "wp-speak-custom-iframe.css");
define("WP_SPEAK_OPEN_CSS_PATH",   		  WP_SPEAK_INCLUDES_PATH . "wp-speak.css");
define("WP_SPEAK_PREVIEW_JS_URL",         WP_SPEAK_INCLUDES_URL  . "wp-speak-preview-XXX.js"); 

define("WP_SPEAK_INIT_JS_URL",            WP_SPEAK_JS_URL        . "wps-init.js"); 
define("WP_SPEAK_MAIN_JS_URL",            WP_SPEAK_DIST_URL      . "wps-main.js"); 
