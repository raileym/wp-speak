 ...
 * OnExpandTest Tests
 */
class OnExpandTest extends WP_UnitTestCase {
	...
	public function testOn01() {
		...
		$result = $this->_url->expand('Test URL', 'Does not matter');
		
        $this->assertEquals(sprintf(BECITEABLE_ERRMSG_EXPAND_BAD_COMM, 'Test URL', ': HTTP Message is not important', 'MC500'), $result['message']);
	...
	public function testOn02() {
        ...
        $this->assertEquals(sprintf(BECITEABLE_ERRMSG_EXPAND_BAD_CREDENTIALS, 'Test URL', 'SC400'), $result['message']);
	...
	public function testOn03() {
        ...
        $this->assertEquals(sprintf(BECITEABLE_ERRMSG_EXPAND_BAD_JSON, 'Test URL', '', 'EC0'), $result['message']);
	...
	public function testOn04() {
		...
		$json_result->longurl = 'http://google.com';
        ...
        $this->assertEquals('http://google.com', $result['long_url']);
